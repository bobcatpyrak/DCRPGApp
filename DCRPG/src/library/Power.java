...
public enum Power 
{
	...
	CHEMICAL_PROJECTION("Chemical Projection", 3, "<html><b>Governing Skills: Resistance, Thrown Weapons</b><br>"
			...
			+ "<b>Lvl 1 - </b>The projectile deals 1D6 poison damage and deals an additional 1 point of damage per round unless eradicated or resisted.<br>"
	...
	ENERGY_PROJECTION("Energy Projection", 2, "<html><b>Governing Skills: Thrown Weapons</b><br>"
			...
			+ "<b>Lvl 1 -</b> The projectile deals 1D6 X-type damage.<br>"
	...
	INVISIBILITY("Invisibility", 7, "<html><b>Governing Skills: Sneak, Resistance</b><br>"
			...
			+ "Lvl. 1 -</b> The character can turn themselves invisible.  This leaves only a faint outline around their body, as if there is a light saran wrap form of a living being replacing their visual presence.  Invisibility is rolled on sneak with no modifiers.<br>"
			+ "Lvl. 3 -</b> At this level the character disappears entirely from view, lowering the difficulty of all sneak roll difficulty modifiers to 1.  Characters who can see only on the visual spectrum will only suss out the presence of the target through alternative means or rolls of 20 or more.  As the level increases, this number rises, reaching a maximum peak of 30.<br>"
			+ "Lvl. 7 -</b> The character can touch other objects, turning them invisible as well.  These objects must be of a mass less than the character’s own.<br>"
			+ "Lvl. 10 -</b> The character can touch any object or individual, turning them invisible, up to 800 pounds in weight.<br></html>.","", "", "Sneak difficulty -1", "", "", "", "Lower mass object Invisibility", "", "", "800lbs max for object invisibility"), 
	...
	PLANT_MIMESIS("Plant Mimesis", 2, "<html><b>Governing Skills: Survival</b><br>"
			...
			+ "Glossary Note: A meta-ability would be considered a skill or power that would be an aberration from the genetic norm of a creature’s species - Solomon Grundy has meta-abilities.<br>"
			+ "Potency Rate: The character’s ceiling on a skill in proportion to that skill level from the plant the character is mimicking<br>"
			+ "<b>Lvl. 1 - </b>The character can tap into any plant’s abilities within 1000 feet, excluding meta-abilities, at a potency rate of 33%.  <br>"
	...
	SHAPECHANGING("Shapechanging", 7, "<html><b>Governing Skills: Artist (Disguise), Bluff, Charm, Intimidation, Any Skill Utilized by Natural Abilities.</b><br>"
			...
			+ "<b>Lvl 4 - </b>At this level, characters can begin attempting to duplicate the appearances of specific individuals.<br>"
	...
	SONAR_SENSE("Sonar Sense", 3, "<html><b>Governing Skills: Perception</b><br>"
			...
			+ "<b>Lvl. 1 - </b>Sonar Sense is acquired.<br>"
			...
			+ "<b>Lvl. 10 -</b> At this level, a character can ping objects through multiple barriers, potentially laying out an entire room in detail..<br>"
			+ "<br><br>Sonar Sense is always rolled as a Perception roll, but the difficulty level is determined by Sonar Sense’s current level, meaning a Level 5 Sonar Sense roll is rolled via Perception, but only if a character has Sonar Sense at Level 5 or more.<br></html>", "Sonar Sense acquired", "", "Can hear through liquids", "", "Can ping  through walls", "", "", "", "", "Advance ping through multiple barriers"), 
	...
	SUPER_REFLEXES("Super Reflexes", 3, "<html><b>Governing Skills: None</b><br>"
			+ "Superattributes are a flat boost to the raw attribute score of any attribute.  Any effects provided by those attributes are boosted accordingly.  Superattributes must be specialized.  In order to take a superattribute, an attribute must be chosen in order for this boost to take effect.  Characters may take multiple superattributes, each leveled independently of one another.<br></html>", "", "", "", "", "", "", "", "", "", ""), 


	SUPER_COORDINATION("Super Coordination", 3, "<html><b>Governing Skills: None</b><br>"
			+ "Superattributes are a flat boost to the raw attribute score of any attribute.  Any effects provided by those attributes are boosted accordingly.  Superattributes must be specialized.  In order to take a superattribute, an attribute must be chosen in order for this boost to take effect.  Characters may take multiple superattributes, each leveled independently of one another.<br></html>", "", "", "", "", "", "", "", "", "", ""), 


	SUPER_PHYSIQUE("Super Physique", 4, "<html><b>Governing Skills: None</b><br>"
			+ "Superattributes are a flat boost to the raw attribute score of any attribute.  Any effects provided by those attributes are boosted accordingly.  Superattributes must be specialized.  In order to take a superattribute, an attribute must be chosen in order for this boost to take effect.  Characters may take multiple superattributes, each leveled independently of one another.<br></html>", "", "", "", "", "", "", "", "", "", ""), 


	SUPER_KNOWLEDGE("Super Knowledge", 3, "<html><b>Governing Skills: None</b><br>"
			+ "Superattributes are a flat boost to the raw attribute score of any attribute.  Any effects provided by those attributes are boosted accordingly.  Superattributes must be specialized.  In order to take a superattribute, an attribute must be chosen in order for this boost to take effect.  Characters may take multiple superattributes, each leveled independently of one another.<br></html>", "", "", "", "", "", "", "", "", "", ""), 


	SUPER_PERCEPTION("Super Perception", 3, "<html><b>Governing Skills: None</b><br>"
			+ "Superattributes are a flat boost to the raw attribute score of any attribute.  Any effects provided by those attributes are boosted accordingly.  Superattributes must be specialized.  In order to take a superattribute, an attribute must be chosen in order for this boost to take effect.  Characters may take multiple superattributes, each leveled independently of one another.<br></html>", "", "", "", "", "", "", "", "", "", ""), 


	SUPER_PRESENCE("Super Prescene", 3, "<html><b>Governing Skills: None</b><br>"
			+ "Superattributes are a flat boost to the raw attribute score of any attribute.  Any effects provided by those attributes are boosted accordingly.  Superattributes must be specialized.  In order to take a superattribute, an attribute must be chosen in order for this boost to take effect.  Characters may take multiple superattributes, each leveled independently of one another.<br></html>", "", "", "", "", "", "", "", "", "", ""), 
	...
	X_RAY_VISION("X-Ray Vision", 3, "<html><b>Governing Skills: Perception</b><br>"
			...
			+ "<b>Lvl. 1 - </b>X-Ray Vision is acquired.<br>"
			...
			+ "<br>"
	 		+ "X-Ray Vision is always rolled as a Perception roll, but the difficulty level is determined by X-Ray Visions current level, meaning a Level 5 X-Ray Vision roll is rolled via Perception, but only if a character has X-Ray Vision at Level 5 or more.<br></html>", "X-Ray vision acquired", "", "See through metal walls", "", "Choice of see through layer", "", "", "", "", "Pick and choose transparency"),
	...
	EMPATHY("Empathy", 2, "<html><b>Governing Skills: Medicine (Psychology), Willpower</b>"
			+ "A character with empathy can detect other character’s emotions and manipulate them using their willpower.<br>"
			+ "<b>Lvl. 1 - </b>This character can roll Medicine (Psychology) to attempt detecting an opposing character’s emotions.  If the opposing character has mental shielding of some sort, they will be too resistant to this discovery.<br>"
	...
	EXPLOSION("Explosion", 5, "<html><b>Governing Skills: Willpower or Hand-to-Hand</b><br>"
			...
			+ "<b>Lvl. 1 - </b>1D6; 1 sq. radius, 1 sq. pushback<br>"
	...
	LANGUAGE_COMPREHENSION("Language Comprehension", 2, "<html><b>Governing Skills: Languages</b><br>"
			...
			+ "<b>Lvl 1. - </b>All language rolls are rolled at advantage.<br>"
	...
	SPEAK_WITH_ANIMALS("Speak with Animals", 2, "<html><b>Governing Skills: Languages</b><br>"
			...
			+ "<b>Lvl 1. -</b> This character can roll Languages to understand animals.<br>"
	...
	SPEAK_WITH_INANIMATES("Speak with Inanimates", 3, "<html><b>Governing Skills: Languages</b><br>"
			...
			+ "<b>Lvl 1. -</b> This character can roll Languages to understand inanimate objects.<br>"
	...
	SPEAK_WITH_PLANTS("Speak with Plants", 2, "<html><b>Governing Skills: Languages</b><br>"
			...
			+ "<b>Lvl 1. -</b> This character can roll Languages to understand plants.<br>"
	...
	FLIGHT("Flight", 3, "<html><b>Governing Skills: Acrobatics (Flight)</b><br>"
			...
			+ "<b>Lvl 1 - </b>200 feet, 4 sq. movement per round.<br>"
	...
	HEALING("Healing", 7, "<html><b>Governing Skills: Medicine, Science, Willpower</b><br>"
			...
			+ "<br>"
			+ "<b>Lvl 1 - </b>Healers can restore up to 10 Body Points per character, plus 5% of their own health.  They can repair minor wounds to the body.  Body points can be restored at a rate of 1D6 per turn.<br>"
	...
	NATURAL_ARMOR("Natural Armor", 3, "<html>Natural Armor is a layer of skin or exoskeleton that can withstand attacks of a certain magnitude.  This deflected damage can measure in a range of 10-20 Body Points in a battle, depending on the level of Natural Armor.  Natural Armor has a pool of 10+X Body Points that can be deflected at any point in combat via d4 rolls. Each d4 roll dictates the amount of damage negated by Natural Armor, up until the pool is depleted in combat.  At level 5, the d4 becomes a d6, and at level 10, it becomes a d8.  The X in 10+X is the level of Natural Armor.<br></html>", "11 BP at d4", "12 BP at d4", "13 BP at d4", "14 BP at d4", "15 BP at d6", "16 BP at d6", "17 BP at d6", "18 BP at d6", "19 BP at d6", "20BP at d8"),
	...
	DARKNESS_MANIPULATION("Darkness Manipulation", 5, "<html><b>Governing Skills: Stealth, Willpower, Intimidation, Survival</b><br>"
		...
		+ "<b>Darkness Manipulation Level Increases</b><br>"
	...
	DENSITY_MANIPULATION("Density Manipulation", 5, "<html><b>Governing Skills: Athletics</b><br>"
		...
		+ "A character begins their turn in either On or Off mode and remains that way until their next turn. <br>"
		+ "<b>Lvl. 1 -</b> A character may utilize Density Manipulation for themselves. <br>"
	...
	MATTER_MANIPULATION("Matter Manipulation", 9, "<html><b>Governing Skills: Science, Resistance, Acrobatics (Flying (Self)), Marksmanship, Physique</b><br>"
			...
			+ "<b>Lvl. 1 - </b>The hero can alter the shape of raw forms of matter in simple ways, increasing or decreasing the amount present, or changing its shape.<br>"
